...
import { idlFactory } from './RakeoffStatistics.did.js';
export { idlFactory } from './RakeoffStatistics.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RAKEOFFSTATISTICS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./RakeoffStatistics.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the RakeoffStatistics canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./RakeoffStatistics.did.js")._SERVICE>}
 */
export const RakeoffStatistics = createActor(canisterId);
